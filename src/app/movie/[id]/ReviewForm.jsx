...
export default function ReviewForm({ movieId, movieTitle, posterPath, existingReview }) {
  ...
  return (
    <form onSubmit={handleSave} className="space-y-6 bg-slate-900/50 p-8 rounded-3xl border border-white/5 backdrop-blur-xl shadow-2xl relative group overflow-hidden">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <textarea 
            ...
            rows={5}
            className="w-full bg-slate-950/50 border border-white/10 rounded-xl p-5 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 placeholder-slate-600 transition-all resize-none"
        ...
        <div className="flex items-center gap-4 pt-4">
          <button 
            type="submit" 
            disabled={loading}
            className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 font-bold text-white rounded-xl transition-all disabled:opacity-50 shadow-lg shadow-indigo-500/25"
          >
